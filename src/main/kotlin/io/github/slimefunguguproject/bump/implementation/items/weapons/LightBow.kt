...
class LightBow(
    ...
    override fun getItemHandler(): BowUseHandler {
        return BowUseHandler { e: EntityShootBowEvent, p: Player, item: ItemStack ->
            e.isCancelled = true
            ...
            if (costHunger(p)) {
                ...
                Bump.localization.sendActionbarMessage(p, "weapon.light_bow")

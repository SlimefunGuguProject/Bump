...
/* 34 */     this.tools = new Category(new NamespacedKey(Bump.getPlugin(Bump.class), "Tools"), new CustomItem(Material.DIAMOND_PICKAXE, "&bBump-工具",  "", "&b&k|&b- 点击打开 >", "", "&7工具,工具!", "他们可能含有未知的力量..." ));

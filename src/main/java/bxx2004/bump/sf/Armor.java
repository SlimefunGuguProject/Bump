...
/* 24 */     this.Armor = new ItemGroup(new NamespacedKey(Bump.getPlugin(Bump.class), "Armor"), new CustomItemStack(Material.DIAMOND_HELMET, "&bBump-护甲", "", "&b&k|&b- 点击打开 >", "", "&7护甲,护甲!", "他们可能含有未知的力量..." ));

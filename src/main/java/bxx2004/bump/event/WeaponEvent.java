...
/*  34 */             SlimefunPlugin.getLocalization().sendActionbarMessage(p, "§b§k|§b- §7§o你现在无法发动该技能!", false);
/*  35 */           } else if (foodLevel < 2) {
/*  36 */             SlimefunPlugin.getLocalization().sendActionbarMessage(p, "§b§k|§b- §7§o你的饱食度不足以转换生命值!", false);
/*  37 */           } else if (foodLevel > 2 && healths - health <= foodLevel) {
/*  38 */             SlimefunPlugin.getLocalization().sendActionbarMessage(p, "§b§k|§b- §7§o已将你的饱食度部分转换为生命值!", false);
/*  39 */             p.setFoodLevel(foodLevel - healths - health);
/*  40 */             p.setHealth((health + healths - health));
/*  41 */           } else if (healths - health > foodLevel) {
/*  42 */             SlimefunPlugin.getLocalization().sendActionbarMessage(p, "§b§k|§b- §7§o已将你的饱食度全部转换生命值!", false);
...
/*  49 */             SlimefunPlugin.getLocalization().sendActionbarMessage(p, "§b§k|§b- §7§o你现在无法发动该技能!", false);
/*     */           } else {
/*  51 */             p.setFoodLevel(p.getFoodLevel() - 5);
/*  52 */             SlimefunPlugin.getLocalization().sendActionbarMessage(p, "§b§k|§b- §7§o斩魔, 一刀致命!", false);
...
/*  61 */             SlimefunPlugin.getLocalization().sendActionbarMessage(p, "§b§k|§b- §7§o你现在无法发动该技能!", false);
/*     */           } else {
/*  63 */             p.setFoodLevel(p.getFoodLevel() - 5);
/*  64 */             SlimefunPlugin.getLocalization().sendActionbarMessage(p, "§b§k|§b- §7§o破天, 一飞冲天!", false);
...
/*  74 */             SlimefunPlugin.getLocalization().sendActionbarMessage(p, "§b§k|§b- §7§o你现在无法发动该技能!", false);
/*     */           } else {
/*  76 */             p.setFoodLevel(p.getFoodLevel() - 5);
/*  77 */             SlimefunPlugin.getLocalization().sendActionbarMessage(p, "§b§k|§b- §7§o破天斩魔,天降正义!", false);
...
/*  92 */                     SlimefunPlugin.getLocalization().sendActionbarMessage(p, "§b§k|§b- §7§o强化时间已经结束!", false);
...
/* 109 */           SlimefunPlugin.getLocalization().sendActionbarMessage(p, "§b§k|§b- §7§o你暂时无法使用它!", false);
/*     */         } else {
/* 111 */           p.setFoodLevel(p.getFoodLevel() - 5);
/* 112 */           SlimefunPlugin.getLocalization().sendActionbarMessage(p, "§b§k|§b- §7§o凋零!", false);
...
/* 119 */           SlimefunPlugin.getLocalization().sendActionbarMessage(p, "§b§k|§b- §7§o你暂时无法使用它!", false);
/*     */         } else {
/* 121 */           p.setFoodLevel(p.getFoodLevel() - 10);
/* 122 */           for (int i = 0; i < 10; i++) {
/* 123 */             SlimefunPlugin.getLocalization().sendActionbarMessage(p, "§b§k|§b- §7§o神罚!", false);
